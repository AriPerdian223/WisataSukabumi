<div class="sidebar bg-gray-800 text-white w-64 min-h-screen flex flex-col items-center py-8">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Logo_Universitas_Nusa_Putra.png/479px-Logo_Universitas_Nusa_Putra.png" alt="Logo-sukabumi" class="logo w-24 mb-8">
