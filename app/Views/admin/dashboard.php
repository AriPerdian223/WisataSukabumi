    ...
    <body class="bg-gray-100">
        ...
        <div class="dashboard-container p-6">
            ...
            <hr class="my-4"/>
            <h2 class="text-2xl font-semibold mb-4">Tempat Wisata Sukabumi</h2>
            <?php if (empty($places)): ?>
                        ...
                        <tbody>
                            <?php foreach ($places as $place) : ?>
                                <tr class="border-b">
                                    ...
                                    <td class="py-2 px-4 location-cell" title="<?= $place['location'] ?>"><?= $place['location'] ?></td>
                                    <td class="py-2 px-4 description-cell"><?= $place['description'] ?></td>
